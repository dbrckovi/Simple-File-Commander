...
draw_file_copy_box :: proc(box: ^FileCopyBox) {
	...
	draw_label_with_value({left, top}, "Files:", "122", 14)
	draw_label_with_value({left, top + 1}, "Directories:", "13", 14)
	draw_label_with_value({left, top + 2}, "Total size:", "14.6 Mb", 14)
	...
	draw_key_with_function({left, top + 8}, "Enter", "Start", 10)
	draw_key_with_function({left, top + 9}, "Esc", "Cancel", 10)
}
